...
Ex : Ergo‑L, AZERTY, QWERTY, Bépo, … Emplacement des lettres, chiffres, symboles sur les touches.

### Configuration clavier programmable

Ex : [Selenium](https://onedeadkey.github.io/selenium/), Miryoku, … Configuration du logiciel du clavier (appelée *firmware*) installé dans les claviers programmables qui modifie l’emplacement des touches elle-mêmes.
